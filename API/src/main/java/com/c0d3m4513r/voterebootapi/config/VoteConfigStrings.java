...
public class VoteConfigStrings {
    ...
    private static ConfigEntry<String> noVoteActive = new ConfigEntry<>(
            ...
            "votereboot.reboot.translate.noVoteActive"
    );
    @Getter
